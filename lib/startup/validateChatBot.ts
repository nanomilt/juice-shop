...
export default function validateChatBot (trainingData: TrainingData, exitOnFailure = true) {
  let success = true
...
export const checkIntentWithFunctionHandlerExists = (trainingData: TrainingData, intent: string, handler: string) => {
  let success = true
